#pragma GCC optimize ("O1")
 #define _y_ 0x02
extern "C" { void start(void); void led(bool); void tenLed(uint8_t); } using ptrFn = void(*)(void);
alignas(0x04) static signed char i{ 0x00 };
__attribute__((pure))
...
alignas(0x08) typedef struct __attribute__((optimize("Os"), (packed), (aligned(0x08))) { unsigned long: 0b00000000; 
